  ...
  return (
    <>
        ...
        <div className="header-content">
          <div className="container">
            <div className="info col-md-7">
              <h2 className="upper main-color">We are always there to guide</h2>
              <h3 className="upper h1">
                providing guidance & mentorship <br /> with practical strategies
              </h3>
              <p>
                The Connect Dot Corp., provides guidance and support to choose
                best from the rest.
              </p>
                ...
                <div className="flex flex-wrap">
                  <div className="flex">
                    <div className="demo-box">
                      <span className="main-color" style={{ fontSize: "28px" }}>
                        Building projects & Internship
                      </span>
                      <p style={{ fontSize: "15px" }}>
                        Practical exposure on the corporate assignment leads to
                        higher chance of selection from the masses.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    <div className="demo-box">
                      ...
                      <p style={{ fontSize: "15px" }}>
                        The career we choose leads to our bright future, we help
                  ...
                  <div className="flex">
                    <div className="demo-box">
                      ...
                      <p style={{ fontSize: "15px" }}>
                        It's the mentor who sees the real potential. Our
                        mentoring leads you explore your potential to the
                        fullest.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    <div className="demo-box">
                      ...
                      <p style={{ fontSize: "15px" }}>
                        The skills needed in the ever changing world are your
                        strength. We help you develop your strength.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="about-company pd-t-b-50">
        <div className="container">
          <div className="row">
            <div className="hidden-xs" style={{ width: "50%", margin: "auto" }}>
              <div className="left-image" style={{ marginLeft: "10px" }}>
                <img
                  className="responsive-img"
