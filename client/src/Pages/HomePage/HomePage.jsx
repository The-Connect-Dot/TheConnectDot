      ...
      <div className="header-content">
        <div className="container">
          <div className="info col-md-7">
            ...
            <h3 className="upper h1">providing guidance & mentorship <br /> with practical strategies</h3>
            <p>
              At The Connect Dot Corp., we provide the necessary guidance and support to make informed choices.
            </p>
            <a className="btn opacity" target="_blank" href="https://forms.gle/XS8EsPMFcRtWpVLc8">Register Here</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="row">
          ...
          <div className="grid col-md-10 col-lg-6">
            <div className="right-info">
              ...
              <h2 className="h2 mg-bottom-15">
                Get to know about<span className="main-color"> our company</span>
              </h2>
              <p className="desc">
              ...
              <div className="grid col-md-4">
                <div className="services-item">
                  ...
                  <div className="services-item-info">
                    ...
                    <a className="btn opacity" target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSfklrhqx5fDBs4R805we3U1tjkAyn36xoNYjjZcTuyxYYeZtw/viewform?usp=sf_link">Register Here</a>
                  </div>
                </div>
              </div>
              <div className="grid col-md-4">
                <div className="services-item">
                  ...
                  <div className="services-item-info">
                    ...
                    <a className="btn opacity" target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSdbC0OZnMtjKy2fmFYY394HvAMWVTz7Ylm-5DjCkCV9M6G9Ig/viewform?usp=sf_link">Register Here</a>
                  </div>
                </div>
              </div>
            </div>
